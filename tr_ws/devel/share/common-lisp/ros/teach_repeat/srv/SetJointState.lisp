...
(cl:defmethod cl:initialize-instance :after ((m <SetJointState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJointState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teach_repeat-srv:<SetJointState-request> is deprecated: use teach_repeat-srv:SetJointState-request instead.")))

(cl:ensure-generic-function 'jointStates-val :lambda-list '(m))
(cl:defmethod jointStates-val ((m <SetJointState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teach_repeat-srv:jointStates-val is deprecated.  Use teach_repeat-srv:jointStates instead.")
  (jointStates m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SetJointState-request>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'jointStates) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SetJointState-request>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'jointStates) istream)
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetJointState-request>)))
  ...
  "teach_repeat/SetJointStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetJointState-request)))
  "Returns string type for a service object of type 'SetJointState-request"
  "teach_repeat/SetJointStateRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetJointState-request>)))
  ...
  "a2e5d0f6e7d0bf3763b0d5e04dd5b765")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetJointState-request)))
  "Returns md5sum for a message object of type 'SetJointState-request"
  "a2e5d0f6e7d0bf3763b0d5e04dd5b765")
...
(cl:defmethod cl:initialize-instance :after ((m <SetJointState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJointState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teach_repeat-srv:<SetJointState-response> is deprecated: use teach_repeat-srv:SetJointState-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetJointState-response>)))
  ...
  "teach_repeat/SetJointStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetJointState-response)))
  "Returns string type for a service object of type 'SetJointState-response"
  "teach_repeat/SetJointStateResponse")
