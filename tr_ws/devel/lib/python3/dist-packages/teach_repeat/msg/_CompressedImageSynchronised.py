...
"""autogenerated by genpy from teach_repeat/CompressedImageSynchronised.msg. Do not edit."""
import codecs
import sys
...
class CompressedImageSynchronised(genpy.Message):
  _md5sum = "c6e5e9dab29899863c78cfe4653e4f3c"
  _type = "teach_repeat/CompressedImageSynchronised"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """sensor_msgs/CompressedImage left
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CompressedImageSynchronised, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.left is None:
        self.left = sensor_msgs.msg.CompressedImage()
      if self.right is None:
        self.right = sensor_msgs.msg.CompressedImage()
    else:
      self.left = sensor_msgs.msg.CompressedImage()
      self.right = sensor_msgs.msg.CompressedImage()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.left.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.left.format = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.right.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.right.format = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
