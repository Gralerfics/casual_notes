...
class data_save:
	...
	def setup_publishers(self):
		# For Multi-Robot System - Teacher Publishers
		self.pub_full_img = rospy.Publisher("teacher_full_img", Image, queue_size=1)
		self.pub_norm_img = rospy.Publisher("teacher_norm_img", Image, queue_size=1)
		self.pub_pose = rospy.Publisher("teacher_odom_pose", Pose, queue_size=1)
